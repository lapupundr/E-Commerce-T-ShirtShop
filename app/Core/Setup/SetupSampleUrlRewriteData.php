...
('regional', '/Ecommerce/Department/Controller/View', '{"id": 1, "color": "black"}' ),
('nature', '/Ecommerce/Department/Controller/View', '{"id": 2, "color": "white"}'),
('seasonal', '/Ecommerce/Department/Controller/View', '{"id": 3, "color": "gray"}');
SQL;
